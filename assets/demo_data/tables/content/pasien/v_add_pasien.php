	...
	<form method="post" class="form-horizontal" action="#">
		<fieldset class="content-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" name="kode_pasien" class="form-control border-lg">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" name="nama" class="form-control border-lg">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="number" name="umur" class="form-control border-lg">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="number" name="berat_badan" class="form-control border-lg">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="number" name="riwayat_diabetes" class="form-control border-lg">
				</div>
			</div>
		</fieldset>
